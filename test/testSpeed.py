'''
    Received the DATA packet and calculate bps
'''
...
class MyDelegate(btle.DefaultDelegate):
    ...
    def handleNotification(self, cHandle, data):
        ...
        totalBytesRx += len(self.rxPacketBuffer)
    ...
    def parseRxPacket(self):
        ...
        if (packetType == DATA):
            ...
            if (dataPacket['seq'] == 40):
                ...
                end_time = time.time()
                print("## ", end_time - start_time, "sec. Total Bytes: ", totalBytesRx)
                print("## ", (totalBytesRx * 8)/(end_time - start_time), "bps")
